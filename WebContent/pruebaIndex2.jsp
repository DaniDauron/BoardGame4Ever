...
<link href="./startbootstrap-shop-item-gh-pages/css/bootstrap_index.css"
	rel="stylesheet" id="bootstrap-css">
<jsp:include page="./imports_comunes.html"/>

<!--  estos son mis putos imports -->
<script src="css//startbootstrap-shop-item-gh-pages/vendor/jquery/jquery.min.js"></script>
...
<meta charset="UTF-8">
	...
	<div class="row">
		<header>
		<jsp:include page="./header.html"/></header>
	<aside>
		<jsp:include page="./sidebar.html"/></aside>
			...
			<div id="carousel-example-generic" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="item active">
						...
						<div>
							<h3>
								<p id="descripcion">AQUI VENDRA LA DESCRIPCION DEL
									JUEGO.....</p>
							</h3>
						</div>
					...
					<div class="item">
						<h1 id="titulo">
							<strong> AQUI VENDRA EL TITULO DEL 2 JUEGO</strong>
							</p>
						</h1>
					...
					<div class="item">
						<h1 id="titulo">
							<strong> AQUI VENDRA EL TITULO DEL JUEGO 3</strong> <img
								src="src/dados.jpg" alt="Tercera dispositiva">
							<!-- Static Header -->
							<div class="header-text hidden-xs"></div>
							<div class="col-md-12 text-center"></div>
							<br>
